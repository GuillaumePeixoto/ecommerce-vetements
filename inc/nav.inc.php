    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?= URL ?>panier.php">Panier <span class="badge bg-success"><?php if(isset($_SESSION['total_prod'])){ echo $_SESSION['total_prod']; } ?></span></a>
                </li>
                <?php if(adminConnect()): ?>
            ...
            <?php if(connect()) : ?>
                <span class="d-flex flex-column justify-content-center align-items-center">
                    <?= '<a class="text-white mb-2" href="profil.php">Bonjour, <span class="text-warning">'.$_SESSION['user']['pseudo'].'</span></a>' ; ?>
                    <a href="<?= URL ?>connexion.php?action=deconnexion" class="text-white btn btn-danger"><i class="bi bi-box-arrow-right"></i> Déconnexion </a>
                </span>
            <?php endif; ?>
            <!-- <form>
