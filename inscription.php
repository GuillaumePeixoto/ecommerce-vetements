<?php
    ...
    */
    ...
    if(isset($_POST['sexe']) && isset($_POST['pseudo']) && isset($_POST['password']) && isset($_POST['confirm_password']) && isset($_POST['email']) && isset($_POST['telephone']) && isset($_POST['prenom']) && isset($_POST['nom']) && isset($_POST['adresse']) && isset($_POST['ville']) && isset($_POST['code_postal']))   
    {
        ...
        if(!empty($_POST['sexe']) && !empty($_POST['pseudo']) && !empty($_POST['password']) && !empty($_POST['confirm_password']) && !empty($_POST['email']) && !empty($_POST['telephone']) && !empty($_POST['prenom']) && !empty($_POST['nom']) && !empty($_POST['adresse']) && !empty($_POST['ville']) && !empty($_POST['code_postal']) && $_POST['pdc'] == 'accepted')  
        {
            $all_input_err = "";
            ...
            $requete = $bdd->prepare("insert into user values(null,:pseudo,:password,:nom,:prenom,:email,:telephone,:sexe,:ville,:code_postal,:adresse,'user')");
            ...
            $requete->bindValue(':telephone',$_POST['telephone'],PDO::PARAM_INT);
            ...
            <form class="row g-3 mb-5" method="post">
                <div class="col-md-6">
                    ...
                    <select type="text" class="form-control" id="sexe" name="sexe">
                        <option value="femme">Madame</otpion>
                ...
                <div class="mb-1 col-6">
                    ...
                    <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Saisir votre adresse téléphone" value="<?php if(isset($_POST['telephone'])){ echo $_POST['telephone'];}?>">
                </div>
                <div class="mb-1 col-6">
